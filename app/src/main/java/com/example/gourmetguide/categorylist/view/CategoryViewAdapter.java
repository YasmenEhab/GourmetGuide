...
public class CategoryViewAdapter extends RecyclerView.Adapter<CategoryViewAdapter.ViewHolder>{
    ...
    public CategoryViewAdapter(List<Meal> c, Context context, onCategoryClickListener _listener ) {
    ...
    public class ViewHolder extends RecyclerView.ViewHolder {
        ...
        public ViewHolder(@NonNull View v) {
            super(v);
            layout = v;
            titleview = v.findViewById(R.id.tv_meal_name_in_category);
            thumbnailimg = v.findViewById(R.id.meal_image_in_category);
            btnShowDetail = v.findViewById(R.id.btn_view_details_in_category);
    ...
    public CategoryViewAdapter.ViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        ...
        CategoryViewAdapter.ViewHolder vh = new CategoryViewAdapter.ViewHolder(v);
