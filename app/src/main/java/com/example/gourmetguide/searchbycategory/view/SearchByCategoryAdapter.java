...
public class SearchByCategoryAdapter extends RecyclerView.Adapter<SearchByCategoryAdapter.ViewHolder>{
    ...
    public SearchByCategoryAdapter(List<Meal> c, Context context, onMealSearchCategoryClickListener _listener ) {
    ...
    public class ViewHolder extends RecyclerView.ViewHolder {
        TextView titleview, priceview, MealOrigin;
        ...
        public ViewHolder(@NonNull View v) {
            ...
            MealOrigin = v.findViewById(R.id.meal_origin);
    ...
    public SearchByCategoryAdapter.ViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        ...
        SearchByCategoryAdapter.ViewHolder vh = new SearchByCategoryAdapter.ViewHolder(v);
    ...
    public void onBindViewHolder(@NonNull SearchByCategoryAdapter.ViewHolder holder, int position) {
        ...
        holder.MealOrigin.setText(p.get(position).getStrArea());
        //  holder.priceview.setText((int) p.get(position).getPrice()+"");
        // holder.ratingbar.setRating((float) p.get(position).getRating()/2);
